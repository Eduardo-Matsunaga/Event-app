                ...
                @foreach ($events as $event)
                    <div class="lg:flex rounded-md" style="background-color: #222831;">
                        <img class="object-cover w-full h-56 rounded-lg lg:w-64"
                             src="{{ asset('/storage/' . $event->image) }}" alt="{{ $event->caption }}">
                        ...
                        <div class="flex flex-col justify-between py-6 lg:mx-6">
                            ...
                            <span
                                class="text-sm text-white dark:text-gray-300 rounded-md p-2" style="background-color: #5C2FC2;">{{ $event->country->name }}</span>
